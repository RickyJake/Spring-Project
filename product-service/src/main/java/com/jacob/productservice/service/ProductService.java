...
import com.jacob.productservice.repository.ProductRepository;
import com.jacob.productservice.utils.EntityDtoUtil;
...
public class ProductService {
    ...
    public Mono<ProductDto> insertProduct(Mono<ProductDto> productDtoMono) {
        return productDtoMono.map(EntityDtoUtil::toEntity)
                ...
                .map(EntityDtoUtil::toDto)
                .doOnNext(this.sink::tryEmitNext); // Whenever there is a new product, we publish it through sink so that people know about it
    }
