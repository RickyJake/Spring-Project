...
import com.jacob.orderservice.dto.UserDto;
import com.jacob.orderservice.service.OrderFulfillmentService;
...
class OrderServiceApplicationTests {
	...
	@Test
	void contextLoads() {
		Flux<PurchaseOrderResponseDto> response = Flux.zip(userClient.getAllUsers(), productClient.getAllProducts())
