...
import com.jacob.webfluxdemo.exception.InputValidationException;
...
public class CalculatorRouterConfig {
    ...
    private RouterFunction<ServerResponse> serverResponseRouterFunction() {
        return RouterFunctions.route()
                ...
                .GET("{a}/{b}", isOperation("-"), handler::substractionandler)
    ...
    private RequestPredicate isOperation(String operation) {
        ...
        return  RequestPredicates.headers(headers -> {
            ...
            return operation.equals(headers.asHttpHeaders()
                .toSingleValueMap()
                .get("OP"));
        });
    }
